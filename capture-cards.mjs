...
const CARDS = [
  { id: 'cta',     index: 0, file: 'card-cta' },
  { id: 'hero',    index: 1, file: 'card-hero' },
  { id: 'mission', index: 2, file: 'card-mission' },
  { id: 'specs',   index: 3, file: 'card-specs' },
  { id: 'kits',    index: 4, file: 'card-kits' },
  { id: 'tech',    index: 5, file: 'card-tech' },
];
